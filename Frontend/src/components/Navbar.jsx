...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full md:h-[8vh] lg:h-[9vh] bg-white shadow-md py-2.5 md:py-2 lg:py-7 2xl:py-3.5 px-5 md:px-10 flex justify-between items-center z-50">
        <Link to="/">
