...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full h-[15.5vh] md:h-[10vh] bg-white shadow-md py-2 md:py-3.5 px-5 md:px-10 flex flex-col md:flex-row md:justify-between items-center gap-3.5 md:gap-0 z-50">
      <div className="flex gap-24 md:gap-0">
        <Link to="/">
      ...
      <div className="flex items-center gap-3">
        <input
          type="text"
          placeholder="Search"
          className="img-serach-input border rounded-md w-[68vw] md:w-[30vw] py-1 px-3 tracking-wider"
        />
        <div className="img-search-btn text-md tracking-wider font-semibold border-2 px-2.5 py-0.5 rounded-md border-green-700 hover:bg-green-700 hover:text-white cursor-pointer">
          Search
        </div>
      </div>
