...
function Post() {
  ...
  return (
    <div>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-x-10 gap-y-5 md:gap-y-10 p-3.5 md:p-5">
        {posts.map((post) => (
          <div
            key={post._id}
            className="md:w-[380px] flex flex-col gap-2 bg-white shadow-md rounded-2xl p-3"
          >
            <img
              src={post.image}
              alt={post.imageName}
